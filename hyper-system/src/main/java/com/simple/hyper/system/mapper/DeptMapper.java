...
public interface DeptMapper extends BaseMapper<Dept> {
    ...
    @Results(id = "BaseResultMap", value = {
        ...
        @Result(column = "id", property = "children", many = @Many(
            select = "com.simple.hyper.system.mapper.DeptMapper.selectDeptListByParentId"
        )),
        @Result(column = "id", property = "users", many = @Many(
            select = "com.simple.hyper.system.mapper.UserMapper.selectUserListByDeptId"
        ))})
    ...
    @Select("<script>" +
        "select id as value, dept_name as title from t_dept " +
        "where deleted = 0 " +
    ...
    @Results(id = "DeptTreeModelResultMap", value = {
        ...
        @Result(column = "value", property = "children", many = @Many(
            select = "com.simple.hyper.system.mapper.DeptMapper.selectDeptTreeModelList"
        ))})
